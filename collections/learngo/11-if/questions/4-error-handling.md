...
2. It's a zero value for pointers or pointer-based types. It means the value is uninitialized. 
3. It's equal to empty string: `"" == nil` is true.


## What's an error value?
1. It stores the error details 
...
2. Using a simple if statement with nil comparison 
...
3. Immediately, after calling a function which returns an error value. 
